...
import me.names.sunhack.api.setting.values.*;
import me.names.sunhack.api.util.misc.MessageBus;
import me.names.sunhack.api.util.render.GSColor;
import me.names.sunhack.client.GameSense;
import me.names.sunhack.api.module.modules.gui.ColorMain;
...
public abstract class Module implements Toggleable, KeybindSetting {
    ...
    public void enable() {
        setEnabled(true);
        SunHack.EVENT_BUS.subscribe(this);
        onEnable();
    ...
    public void disable() {
        setEnabled(false);
        SunHack.EVENT_BUS.unsubscribe(this);
        onDisable();
